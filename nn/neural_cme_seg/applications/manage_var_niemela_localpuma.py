...
def manage_variables_niemela(cme_date_event,btot=False,real_img=False,auxiliar='',instr='',infer_event2=False,modified_masks=None,
    ...
    if real_img:
        ...
        if modified_masks:
            if instr == 'cor2_a':
                modified_masks = extra_path+'/gehme/projects/2023_eeggl_validation/repo_diego/2020_gcs_with_ml/nn/neural_cme_seg/applications/niemela_proyect/new_masks20100403_cor2a_v4.pkl'
            if instr == 'cor2_b':
                modified_masks = extra_path+'/gehme/projects/2023_eeggl_validation/repo_diego/2020_gcs_with_ml/nn/neural_cme_seg/applications/niemela_proyect/new_masks20100403_cor2b_v6.pkl'
            if instr == 'lascoC2':
